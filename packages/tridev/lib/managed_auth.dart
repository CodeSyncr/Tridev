...
/// The `tridev db` tool will create database tables for these types as long as they are visible
/// to the application's library file, as noted above.
library tridev.managed_auth;

import 'dart:async';

import 'package:tridev/src/db/managed/attributes.dart';
...
/// code flow.
///
/// Use the `tridev auth` tool to add new clients to an application.
