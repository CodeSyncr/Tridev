...
///
/// A Tridev application creates instances of this type to pair an HTTP server and an
...
class ApplicationServer {
  ...
  Future didOpen() async {
    server!.serverHeader = "tridev/$identifier";
    ...
    logger.info("Server tridev/$identifier started.");
  }
