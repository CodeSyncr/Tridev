...
import 'package:tridev/src/cli/commands/document_serve.dart';
import 'package:tridev/src/cli/commands/oai_client.dart';
import 'package:tridev/src/cli/mixins/openapi_options.dart';
import 'package:tridev/src/cli/mixins/project.dart';
import 'package:tridev/src/cli/scripts/openapi_builder.dart';
...
class CLIDocument extends CLICommand with CLIProject, CLIDocumentOptions {
  ...
  String get detailedDescription {
    return "This tool will generate an OpenAPI specification of a Tridev application. It operates by invoking Application.document. "
