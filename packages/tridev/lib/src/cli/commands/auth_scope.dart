...
import 'package:tridev/src/auth/objects.dart';
import 'package:tridev/src/cli/command.dart';
import 'package:tridev/src/cli/metadata.dart';
import 'package:tridev/src/cli/mixins/database_connecting.dart';
import 'package:tridev/src/cli/mixins/database_managing.dart';
import 'package:tridev/src/cli/mixins/project.dart';
import 'package:tridev/src/db/managed/context.dart';
...
class CLIAuthScopeClient extends CLICommand
  ...
  String get description {
    return "Sets the scope of an existing OAuth 2.0 client in a database that has been provisioned with the tridev/managed_auth package.";
  }
}
